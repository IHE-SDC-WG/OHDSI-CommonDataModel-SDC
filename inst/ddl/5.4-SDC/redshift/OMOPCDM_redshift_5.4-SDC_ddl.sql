...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.templatesdcclass  (pk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.templateinstanceclass  (pk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.sdcobsclass  (pk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.templatetermmapclass  (pk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.templatemapcontentclass  (pk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.specimenclass  (specimenpk integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.observationspecimensclass  (observationspecimensclasspk integer NOT NULL,
