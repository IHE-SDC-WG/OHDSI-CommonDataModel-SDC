--redshift CDM DDL Specification for OMOP Common Data Model 5.4-SDC
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.template_sdc  (template_sdc_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.template_item  (template_item_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @cdmDatabaseSchema.template_instance  (template_instance_id integer NOT NULL,
...
DISTKEY(person_id);
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.sdc_observation  (sdc_observation_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.template_term_map  (template_term_map_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.template_map_content  (template_map_content_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.sdc_specimen  (sdc_specimen_id integer NOT NULL,
...
DISTSTYLE ALL;
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.observation_specimens  (observation_specimens_id integer NOT NULL,
