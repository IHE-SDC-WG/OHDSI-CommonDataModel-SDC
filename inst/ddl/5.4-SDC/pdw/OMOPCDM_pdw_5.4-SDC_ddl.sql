--pdw CDM DDL Specification for OMOP Common Data Model 5.4-SDC
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.templatesdcclass  (pk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.templateinstanceclass  (pk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.sdcobsclass  (pk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.templatetermmapclass  (pk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.templatemapcontentclass  (pk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.specimenclass  (specimenpk integer NOT NULL,
...
WITH (DISTRIBUTION = REPLICATE);
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; CREATE TABLE @cdmDatabaseSchema.observationspecimensclass  (observationspecimensclasspk integer NOT NULL,
