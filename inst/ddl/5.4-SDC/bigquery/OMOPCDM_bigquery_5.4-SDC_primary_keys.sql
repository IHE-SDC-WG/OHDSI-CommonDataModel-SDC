...
alter table @cdmDatabaseSchema.templatesdcclass add constraint xpk_templatesdcclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templateinstanceclass add constraint xpk_templateinstanceclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.sdcobsclass add constraint xpk_sdcobsclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templatetermmapclass add constraint xpk_templatetermmapclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templatemapcontentclass add constraint xpk_templatemapcontentclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templatesdcclass add constraint xpk_templatesdcclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templateinstanceclass add constraint xpk_templateinstanceclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.sdcobsclass add constraint xpk_sdcobsclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templatetermmapclass add constraint xpk_templatetermmapclass primary key nonclustered (pk);
...
alter table @cdmDatabaseSchema.templatetermmapclass add constraint xpk_templatetermmapclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.templatemapcontentclass add constraint xpk_templatemapcontentclass primary key nonclustered (pk);
alter table @cdmDatabaseSchema.specimenclass add constraint xpk_specimenclass primary key nonclustered (specimenpk);
alter table @cdmDatabaseSchema.observationspecimensclass add constraint xpk_observationspecimensclass primary key nonclustered (observationspecimensclasspk);
