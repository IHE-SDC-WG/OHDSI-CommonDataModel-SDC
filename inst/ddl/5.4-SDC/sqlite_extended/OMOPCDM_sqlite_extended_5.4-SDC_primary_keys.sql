...
ALTER TABLE @cdmDatabaseSchema.templatesdcclass ADD CONSTRAINT xpk_templatesdcclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT xpk_templateinstanceclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT xpk_sdcobsclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templatemapcontentclass ADD CONSTRAINT xpk_templatemapcontentclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templatesdcclass ADD CONSTRAINT xpk_templatesdcclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT xpk_templateinstanceclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT xpk_sdcobsclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
...
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.templatemapcontentclass ADD CONSTRAINT xpk_templatemapcontentclass PRIMARY KEY (pk);
ALTER TABLE @cdmDatabaseSchema.specimenclass ADD CONSTRAINT xpk_specimenclass PRIMARY KEY (specimenpk);
ALTER TABLE @cdmDatabaseSchema.observationspecimensclass ADD CONSTRAINT xpk_observationspecimensclass PRIMARY KEY (observationspecimensclasspk);
