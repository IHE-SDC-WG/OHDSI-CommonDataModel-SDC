--sqlite extended CDM Primary Key Constraints for OMOP Common Data Model 5.4-SDC
...
ALTER TABLE @cdmDatabaseSchema.template_sdc ADD CONSTRAINT xpk_template_sdc PRIMARY KEY (template_sdc_id);
ALTER TABLE @cdmDatabaseSchema.template_item ADD CONSTRAINT xpk_template_item PRIMARY KEY (template_item_id);
ALTER TABLE @cdmDatabaseSchema.template_instance ADD CONSTRAINT xpk_template_instance PRIMARY KEY (template_instance_id);
ALTER TABLE @cdmDatabaseSchema.sdc_observation ADD CONSTRAINT xpk_sdc_observation PRIMARY KEY (sdc_observation_id);
ALTER TABLE @cdmDatabaseSchema.template_term_map ADD CONSTRAINT xpk_template_term_map PRIMARY KEY (template_term_map_id);
ALTER TABLE @cdmDatabaseSchema.template_map_content ADD CONSTRAINT xpk_template_map_content PRIMARY KEY (template_map_content_id);
ALTER TABLE @cdmDatabaseSchema.sdc_specimen ADD CONSTRAINT xpk_sdc_specimen PRIMARY KEY (sdc_specimen_id);
ALTER TABLE @cdmDatabaseSchema.observation_specimens ADD CONSTRAINT xpk_observation_specimens PRIMARY KEY (observation_specimens_id);
