--sqlite extended CDM Foreign Key Constraints for OMOP Common Data Model 5.4-SDC
...
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_templatesdcfk FOREIGN KEY (templatesdcfk) REFERENCES @cdmDatabaseSchema.templatesdcclass (pk);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_personfk FOREIGN KEY (personfk) REFERENCES @cdmDatabaseSchema.person (person_id);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_encounterfk FOREIGN KEY (encounterfk) REFERENCES @cdmDatabaseSchema.visit_occurrence (visit_occurrence_id);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_practitionerfk FOREIGN KEY (practitionerfk) REFERENCES @cdmDatabaseSchema.provider (provider_id);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_templateinstanceclassfk FOREIGN KEY (templateinstanceclassfk) REFERENCES @cdmDatabaseSchema.templateinstanceclass (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_parentfk FOREIGN KEY (parentfk) REFERENCES @cdmDatabaseSchema.sdcobsclass (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_personfk FOREIGN KEY (personfk) REFERENCES @cdmDatabaseSchema.person (person_id);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_encounterfk FOREIGN KEY (encounterfk) REFERENCES @cdmDatabaseSchema.visit_occurrence (visit_occurrence_id);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_practitionerfk FOREIGN KEY (practitionerfk) REFERENCES @cdmDatabaseSchema.provider (provider_id);
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT fpk_templatetermmapclass_templatesdcfk FOREIGN KEY (templatesdcfk) REFERENCES @cdmDatabaseSchema.templatesdcclass (pk);
ALTER TABLE @cdmDatabaseSchema.templatemapcontentclass ADD CONSTRAINT fpk_templatemapcontentclass_templatetermmap_fk FOREIGN KEY (templatetermmap_fk) REFERENCES @cdmDatabaseSchema.templatetermmapclass (pk);
ALTER TABLE @cdmDatabaseSchema.specimenclass ADD CONSTRAINT fpk_specimenclass_parentspecimenfk FOREIGN KEY (parentspecimenfk) REFERENCES @cdmDatabaseSchema.specimenclass (specimenpk);
ALTER TABLE @cdmDatabaseSchema.observationspecimensclass ADD CONSTRAINT fpk_observationspecimensclass_sdcobsclassfk FOREIGN KEY (sdcobsclassfk) REFERENCES @cdmDatabaseSchema.sdcobsclass (pk);
ALTER TABLE @cdmDatabaseSchema.observationspecimensclass ADD CONSTRAINT fpk_observationspecimensclass_specimenfk FOREIGN KEY (specimenfk) REFERENCES @cdmDatabaseSchema.specimenclass (specimenpk);
