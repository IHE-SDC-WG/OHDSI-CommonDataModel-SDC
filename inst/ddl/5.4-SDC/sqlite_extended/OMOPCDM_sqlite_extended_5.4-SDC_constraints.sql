...
ALTER TABLE @cdmDatabaseSchema.sdc_specimen ADD CONSTRAINT fpk_sdc_specimen_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES @cdmDatabaseSchema.visit_occurrence (visit_occurrence_id);
ALTER TABLE @cdmDatabaseSchema.observation_specimens ADD CONSTRAINT fpk_observation_specimens_sdc_observation_id FOREIGN KEY (sdc_observation_id) REFERENCES @cdmDatabaseSchema.sdc_observation (sdc_observation_id);
ALTER TABLE @cdmDatabaseSchema.observation_specimens ADD CONSTRAINT fpk_observation_specimens_sdc_specimen_id FOREIGN KEY (sdc_specimen_id) REFERENCES @cdmDatabaseSchema.sdc_specimen (sdc_specimen_id);
