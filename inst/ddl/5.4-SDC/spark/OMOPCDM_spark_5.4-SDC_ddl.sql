...
CAST(NULL AS integer) AS procedure_occurrence_id,
	...
	IF(try_cast(NULL  AS DATE) IS NULL, to_date(cast(NULL  AS STRING), 'yyyyMMdd'), try_cast(NULL  AS DATE)) AS procedure_end_date,
...
CAST(NULL AS integer) AS episode_id,
	...
	IF(try_cast(NULL  AS DATE) IS NULL, to_date(cast(NULL  AS STRING), 'yyyyMMdd'), try_cast(NULL  AS DATE)) AS episode_start_date,
	CAST(NULL AS TIMESTAMP) AS episode_start_datetime,
	IF(try_cast(NULL  AS DATE) IS NULL, to_date(cast(NULL  AS STRING), 'yyyyMMdd'), try_cast(NULL  AS DATE)) AS episode_end_date,
...
CAST(NULL AS integer) AS sdc_observation_id,
	...
	CAST(NULL AS STRING) AS question_instance_guid,
	...
	CAST(NULL AS integer) AS response_int,
