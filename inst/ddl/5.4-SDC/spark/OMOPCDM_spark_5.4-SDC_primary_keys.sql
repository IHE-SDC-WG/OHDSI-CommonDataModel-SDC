...
ALTER TABLE @cdmDatabaseSchema.templatesdcclass ADD CONSTRAINT xpk_templatesdcclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT xpk_templateinstanceclass  (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT xpk_sdcobsclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templatemapcontentclass ADD CONSTRAINT xpk_templatemapcontentclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templatesdcclass ADD CONSTRAINT xpk_templatesdcclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templateinstanceclass ADD CONSTRAINT xpk_templateinstanceclass  (pk);
ALTER TABLE @cdmDatabaseSchema.sdcobsclass ADD CONSTRAINT xpk_sdcobsclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass  (pk);
...
ALTER TABLE @cdmDatabaseSchema.templatetermmapclass ADD CONSTRAINT xpk_templatetermmapclass  (pk);
ALTER TABLE @cdmDatabaseSchema.templatemapcontentclass ADD CONSTRAINT xpk_templatemapcontentclass  (pk);
ALTER TABLE @cdmDatabaseSchema.specimenclass ADD CONSTRAINT xpk_specimenclass  (specimenpk);
ALTER TABLE @cdmDatabaseSchema.observationspecimensclass ADD CONSTRAINT xpk_observationspecimensclass  (observationspecimensclasspk);