...
ALTER TABLE @cdmDatabaseSchema.template_map_content ADD CONSTRAINT xpk_template_map_content  (template_map_content_id);
ALTER TABLE @cdmDatabaseSchema.sdc_specimen ADD CONSTRAINT xpk_sdc_specimen  (sdc_specimen_id);
ALTER TABLE @cdmDatabaseSchema.observation_specimens ADD CONSTRAINT xpk_observation_specimens  (observation_specimens_id);